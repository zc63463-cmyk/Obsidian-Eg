...
> **原型义**：家里的、房屋内的
> **延伸维度**：社会路径
> **隐喻类型**：结构隐喻（从"家里的"→"国内的"→"驯养的"）

## 词根词缀

dom-(=domus，房屋、家) + -estic(形容词后缀，表示"与……有关的")
**叙事**：与**房屋/家**有关的一切——家里的（家庭的），本国家里的（国内的），被驯化养在家里的（驯养的）。
...
>    - → **家庭的、家用的**（生活层面：与家庭生活相关）
>      - 激活条件：描述家庭事务、家用设备
>    - → **国内的、本国的**（国家层面：把"家"的范围扩大到国家）
>      - 激活条件：描述国内事务、国内市场
>    - → **驯养的**（生物层面：被驯化养在家里的动物）
>      - 激活条件：描述与野生动物相对的家养动物
...
- **延伸中心**：以"与家相关"为特征，从家庭延伸到国家再到驯养动物
- **一句话统筹**：所有义项都围绕"与'家'的范围相关"

> [!check]- 链路验证
> - [x] **可逆性**：从"domestic market"可反向推导到"家里的"（本国"家"里的市场）
> - [x] **可统筹**：一句话"与'家'的范围相关"串联所有义项
> - [x] **有支撑**：考研中"domestic market/economy/policy"为极高频搭配
...
> | 词性 | 释义 | 转换路径 |
> |------|------|---------|
> | adj. | 国内的、家庭的、驯养的 | 基本词性 |
> | n. (domestic) | 家仆、佣人（罕见） | adj→n：零派生，"家里的"→"在家里做事的人" |
...
>
> **词拆分记忆**：
> dom（dome 圆顶屋）+ estic（Easter 复活节的）→ 复活节在家里的圆顶屋中度过——"家庭的/国内的"。
...
> |------|------------|---------|---------|---------|
> | [[internal]] | 内部的 | 强调在边界之内 | 市场、政策 | 中性/正式 |
> | [[household]] | 家庭的 | 强调与家庭住户相关 | 收入、用品 | 中性 |
> | [[home]] | 家的 | 最通用，口语化 | 生活、事务 | 正面/温暖 |
> | **domestic** | 国内的、家庭的 | 强调与"家"的范围相关 | 市场、经济、动物 | 中性/正式 |
>
> **"增"标记**：domestic **(增-家的多层扩展性)** vs internal/household
...
> | 派生词 | 构词分析 | 释义 | 链接关系 |
> |--------|---------|------|---------|
> | [[domain]] | dom-(房屋) + -ain(名词后缀) | 领域、领地 | 词义补充：同源词，从"家"延伸到"领地" |
> | domestically | domestic + -ly(副词后缀) | 在国内地 | 词义填充 |
> | domesticate | domestic + -ate(动词后缀) | 驯养 | 词义补充：动词形式补充动作义 |
