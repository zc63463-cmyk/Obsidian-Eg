...
> **延伸维度**：抽象路径
> **隐喻类型**：本体隐喻（"勇气"作为可被"注入"的实体 → 鼓励、促进）

## 词根词缀

[[up]](向上、使能，en- 为原始印欧语同源) + cour/cor(心，拉丁语 cor/cordis，courage 来自此) + -age(名词后缀，此处为动词化)
**叙事**：**en**（使）+ **cour**（心，来自拉丁语 cor）→ **使**心里有力量，这就是 encourage（鼓励）。当朋友失落时，你的一番话**注入了他的心**，让他重新有了勇气。
...
>      - 激活条件：支持某项事业、赞助某项活动时
> 2. **注入勇气**（结果层面）
>    - → **促进，助长**：使某事更有可能发生（中性或负面用法）
>      - 激活条件：描述促进某种行为或现象时

### 统筹（选择适用的模式）

- **v + 不同宾语**：encourage + 人 → 鼓励；encourage + 行为 → 促进/助长
- **一句话统筹**：encourage 就是"注入勇气"——鼓励人、促进事

> [!check]- 链路验证
> - [x] **可逆性**：从"助长"能反向推导到"注入勇气"——助长就是给某行为注入了"勇气"
> - [x] **可统筹**：一句话统筹——"encourage 就是注入勇气"
> - [x] **有支撑**：encourage sb. to do, encourage innovation 均为考研高频搭配
...
> |------|------------|---------|---------|---------|
> | [[inspire]] | 激发/鼓舞 | 强调通过榜样或精神力量激发 | 创造力、热情、行动 | 积极/强烈 |
> | [[motivate]] | 激励 | 强调提供动机和内在驱动力 | 员工、学生、行为 | 积极/理性 |
> | [[stimulate]] | 刺激/激发 | 强调引起反应或活力 | 经济、思维、兴趣 | 中性偏积极 |
> | [[encourage]] | 鼓励/促进 | 最通用，强调给予信心和支持 | 人、行为、创新 | 积极/温暖 |
>
> **"增"标记**：encourage **(增-温暖的人际感)** vs motivate（基准词：理性驱动）；encourage **(增-通用性和日常感)** vs inspire（基准词：精神感召）
...
> | 派生词 | 构词分析 | 释义 | 链接关系 |
> |--------|---------|------|---------|
> | [[courage]] | cor（心）+ -age | 勇气 | 词义补充（核心词根成分） |
> | [[encouragement]] | encourage + -ment（名词后缀） | 鼓励；激励 | 词义填充 |
> | [[encouraging]] | encourage + -ing（形容词后缀） | 鼓舞人心的 | 词义填充 |
> | [[discourage]] | dis-（去掉）+ courage | 使气馁；阻止 | 词义补充（反义词） |
> | [[courageous]] | courage + -ous（充满的） | 勇敢的 | 词义补充 |
