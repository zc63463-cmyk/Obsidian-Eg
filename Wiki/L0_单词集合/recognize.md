...
re-（再/重新）+ cogn/gn（[[id-ident]] 认知/知道）+ -ize（动词后缀，使...化）
**叙事**：让大脑再次启动认知功能——认出曾经认识的事物或承认其价值。
...
> 1. **再次认知**（认知层面：重新认出）
>    - → **认出；识别**（感知层面：辨认出人或物）
>      - 激活条件：搭配 recognize sb./sth. 时
>    - → **承认；认可**（社会层面：正式承认某事物的合法性或价值）
>      - 激活条件：搭配 be recognized as, recognize independence 时
>    - → **意识到**（认知层面：认识到某个事实）
>      - 激活条件：搭配 recognize that... 时

### 统筹（选择适用的模式）

- **一句话统筹**：重新认出→承认其存在/价值→意识到

> [!check]- 链路验证
> - [x] **可逆性**：承认 = 认出其价值；意识到 = 认出事实，均可逆推
> - [x] **可统筹**："再次认知"串联从感知到认知的所有义项
> - [x] **有支撑**：recognize a face（认出面孔）/ recognize a country（承认一个国家）
...
> |------|------|---------|
> | vt. | 认出；承认；意识到 | 基本词性 |
> | n. (recognition) | 认出；承认；表彰 | v→n（-ize→-ition） |
...
>
> **词拆分记忆**（辅助）：
> re（再）+ cogn（认知，同 ident）+ -ize（动词化）→ 再次认知 → 认出/承认
...
> |------|------------|---------|---------|---------|
> | [[identify]] | 鉴定 | 确认身份 | 人/物 | 中性 |
> | [[acknowledge]] | 承认 | 被动确认 | 事实/权利 | 中性 |
> | **recognize** | 认出/承认 | 重新认知 | 人/事实/国家 | 积极 |
>
> **"增"标记**：recognize **(增-从"重新认出"到"承认"的完整语义链)** vs identify
...
> | 派生词 | 构词分析 | 释义 | 链接关系 |
> |--------|---------|------|---------|
> | [[recognition]] | recognize + -ition | 认出；承认；表彰 | 词义补充 |
> | [[recommend]] | 同源词（re- + com- + mend） | 推荐 | 同源关系 |
...
>   - 来源：Oxford | https://www.oxfordlearnersdictionaries.com/definition/english/recognize
>   - 中译：【需人工审核】与 recognize 相关的例句。
