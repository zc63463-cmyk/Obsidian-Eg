...
> [!example]- 语料 · L3
> - "A striking feature of the painting is its use of vivid colors and bold contrasts."（这幅画的一个显著特征是其对鲜艳色彩和大胆对比的运用。）——考研高频表达
> - "There is a striking similarity between the two cases that cannot be ignored."（这两个案件之间存在不容忽视的惊人相似之处。）——考研高频表达
...
>
> - [ ] 词根笔记：stric（击打）
> - [ ] 同义辨析：striking, remarkable, obvious
> - [ ] 反义词群：unremarkable, ordinary
> - [ ] 形近词群：[[stride]], [[strike]], [[string]]
