...
> [!info] 基础信息
> **音标** /ˈtʃerɪʃ/ | **词级** 必备词 | **语义场** [[人本世界]]

## 核心释义

**v.** ①==**珍爱，钟爱**== ;  `V N`②珍惜，怀有（希望、梦想等） ;  `V prep N`③爱护，关怀 `V N`

> [!tip] 原型义
> **原型义**：珍爱、关爱
> **延伸维度**：情感路径
> **隐喻类型**：本体隐喻（从物理上的珍护→情感上的珍视）

## 词根词缀

cher-(=car-/cur，关心、珍爱，与 care 同源) + -ish(动词后缀，表"使...、做...")
**叙事**：用心去关爱某人或某物，像保护宝贝一样，就是"珍爱"。
...
- **v + 不同宾语**：cherish 不同宾语产生不同含义——cherish a person（珍爱某人）→ cherish a memory（珍惜回忆）→ cherish a hope（怀有希望）
- **延伸中心**：以"用心珍护"为特征，从对人的关爱延伸到对事物的珍惜、对情感的怀有

> [!check]- 链路验证
> - [x] **可逆性**：从"怀有希望"可反向推导到"珍爱"（怀有=珍视心中的希望）
> - [x] **可统筹**：一句话"用心珍护"串联所有义项
> - [x] **有支撑**：考研中"cherish the memory/freedom"为高频表达
...
>
> **词拆分记忆**：
> cher（樱桃cherry的缩写）+ ish（鱼）→ 樱桃和小鱼都是需要"珍爱"的可爱事物。
...
> |------|------------|---------|---------|---------|
> | [[treasure]] | 珍视、珍藏 | 强调视为珍宝 | 回忆、友谊 | 深情/正面 |
> | [[prize]] | 珍视 | 强调高度重视 | 自由、品质 | 正面/强烈 |
> | [[value]] | 重视 | 最通用，强调认为有价值 | 任何事物 | 中性/正面 |
> | **cherish** | 珍爱、珍惜 | 强调充满感情的关爱 | 人、回忆、希望 | 温暖/深情 |
>
> **"增"标记**：cherish **(增-温暖深厚的情感温度)** vs treasure/value
...
> | 派生词 | 构词分析 | 释义 | 链接关系 |
> |--------|---------|------|---------|
> | cherished | cherish + -ed(过去分词) | 珍爱的、珍视的 | 词义补充：形容词形式补充动词品质 |
