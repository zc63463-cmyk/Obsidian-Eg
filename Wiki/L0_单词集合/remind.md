...
re-(back/again) + 建议创建词根笔记 [[re/rem]](mind/心) + (无后缀)
%% re/rem 词根笔记尚未创建，建议创建 %%
**叙事**：把某件事再次放回别人的"心"里——就是"提醒"。
...
> 1. **把想法重新放回脑海中**（心理层面）
>    - → **提醒**：让别人想起该做的事
>      - 激活条件：remind sb. to do sth. / remind sb. of sth.
    - → **使想起；使发生联想**：某物让人联想到另一件事
>      - 激活条件：sth. reminds sb. of sth.

### 统筹

- **一字一词概括**："唤"——唤起记忆→唤起注意→唤起联想
- **一句话统筹**：remind 就是让记忆"回来"

> [!check]- 链路验证
> - [x] **可逆性**：从"使发生联想"可反向推导至"让某物唤起对另一物的记忆"
> - [x] **可统筹**：一个"唤"字串联所有义项
> - [x] **有支撑**：remind sb. of sth.（让某人想起）为考研高频搭配
...
> |------|------------|---------|---------|---------|
> | [[notify]] | 通知 | 强调信息传达 | 会议、决定、变更 | 正式中性 |
> | [[warn]] | 警告 | 强调危险预告 | 风险、后果 | 偏消极 |
> | [[prompt]] | 促使；提示 | 强调触发行动 | 行动、思考 | 中性 |
> | **remind** | 提醒；使想起 | 强调唤起记忆 | 事情、约定、人 | 中性偏积极 |
>
> **"增"标记**：remind **(增-记忆唤起感)** vs notify
...
> | 派生词 | 构词分析 | 释义 | 链接关系 |
> |--------|---------|------|---------|
> | [[reminder]] | remind + -er(名词后缀，表物) | 提醒物；提示 | 词义填充 |
