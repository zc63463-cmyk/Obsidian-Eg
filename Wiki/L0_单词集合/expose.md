...
**v.** ①==**暴露，揭露**== `V N` `V N to N`；②==**使暴露于（危险等）**== `V N to N`；③使接触（体验） `V N to N`；④显露（感情等） `V N`；
...
>   - 来源：Oxford | https://www.oxfordlearnersdictionaries.com/definition/english/expose
>   - 中译：【需人工审核】与 expose 相关的例句。
