...
> [!info] 基础信息
> **音标** /pɔːtˈfəʊliəʊ/ | **词级** 基础词 | **语义场** [[物品工具]]

## 核心释义

**n.** ①==**公文包**== `N` [通用]；②==**投资组合**==（证券组合）`investment N` [金融]；③==**作品集**==（设计师/艺术家的）`design/art N` [艺术]；④==**部长职务**==（英式英语，如 Minister without portfolio）`N of responsibilities` [政治]；
