...
ephemer-(短暂的，源自希腊语 *ephemeros*，"只存在一天的") + -a(名词后缀，复数)
**叙事**：ephemer（只存在一天的）+ a → **只存在一天的东西** → 短暂之物。希腊语 ephemeros 描述的是只活一天的蜉蝣——ephemera 就是像蜉蝣一样转瞬即逝的东西。
...
> 1. **只存在一天**（时间层面）
>    - → **短暂的事物**：转瞬即逝的东西
>      - 激活条件：the ephemera of fashion
>    - → **临时性印刷品**：票根、传单等短暂使用的纸质品
>      - 激活条件：collecting ephemera

### 统筹（选择适用的模式）

- **一字一词概括**：ephemera 就是"短暂之物"——时尚是短暂的，传单是短暂的
- **延伸中心**：从"只活一天的昆虫"延伸到"一切转瞬即逝的事物"

> [!check]- 链路验证
> - [ ] **可逆性**：从"临时性印刷品"能反向推导到"短暂之物"
> - [ ] **可统筹**：一句话——"ephemera 就是转瞬即逝的东西"
> - [ ] **有支撑**：the ephemera of fashion, collecting ephemera 均有语料支撑
...
> | 词性 | 释义 | 转换路径 |
> |------|------|---------|
> | n. | 短暂的事物；临时印刷品 | ephemer-(短暂) + -a（复数名词） |
> | adj. (ephemeral) | 短暂的，转瞬即逝的 | ephemer- + -al |
...
> |------|------------|---------|---------|---------|
> | [[transient]] | 短暂的 | 强调持续时间短 | 人口、现象 | 中性 |
> | [[fleeting]] | 转瞬即逝的 | 强调速度极快 | 时间、印象 | 中性/文学 |
> | **ephemera** | 短暂的事物 | 强调只存在极短时间的物品/现象 | 时尚、印刷品 | 中性/学术 |
...
> | 派生词 | 构词分析 | 释义 | 链接关系 |
> |--------|---------|------|---------|
> | [[ephemeral]] | ephemer- + -al | 短暂的，转瞬即逝的 | 词义补充 |
> | [[ephemerally]] | ephemeral + -ly | 短暂地 | 词义补充 |
