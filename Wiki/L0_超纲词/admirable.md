...
> **原型义**：值得惊叹的（令人想要仰望和模仿）
> **延伸维度**：抽象路径
> **隐喻类型**：结构隐喻（"仰望"= 钦佩——空间上的向上看→心理上的赞赏）

## 词根词缀

ad-(朝向) + [[mir|vis-vid]](看，惊叹) + -able(可以被)
**叙事**：ad（朝向）+ mir（看/惊叹）+ able（可以被）→ **值得被惊叹地看待** → 令人钦佩的。miracle（奇迹）同源——让人惊叹的事物。建议创建词根笔记 [[mir-]]。
...
> 1. **值得被惊叹**（心理层面）
>    - → **令人钦佩的**：值得被赞赏和仰慕
>      - 激活条件：admirable courage
>    - → **极好的，出色的**：值得称赞的品质
>      - 激活条件：an admirable achievement

### 统筹（选择适用的模式）

- **一字一词概括**：admirable 就是"赞"——让人看了忍不住赞叹
- **延伸中心**：从"令人惊叹"延伸到"值得赞赏"

> [!check]- 链路验证
> - [x] **可逆性**：从"出色的成就"能反向推导到"值得惊叹"——出色的成就就是让人惊叹的
> - [x] **可统筹**：一句话——"admirable 就是值得被惊叹地看待的品质"
> - [x] **有支撑**：admirable courage, admirable achievement 均有语料支撑
...
> | 词性 | 释义 | 转换路径 |
> |------|------|---------|
> | adj. | 令人钦佩的；极好的 | admire + -able（可以被钦佩的） |
...
>
> **词拆分记忆**（辅助）：
> ad（朝向）+ mir（看，如 mirror 镜子→让人看）+ able → 值得被看 → 令人钦佩的
...
> |------|------------|---------|---------|---------|
> | [[respectable]] | 值得尊敬的 | 强调社会地位和品行 | 人、家庭、成绩 | 正面/庄重 |
> | [[commendable]] | 值得赞许的 | 强调值得表扬 | 行为、努力 | 正面/正式 |
> | **admirable** | 令人钦佩的 | 强调令人惊叹和仰慕 | 品质、勇气、成就 | 强烈正面 |
>
> **"增"标记**：admirable **(增-惊叹感和仰慕强度)** vs commendable（基准词：值得赞许）
...
> | 派生词 | 构词分析 | 释义 | 链接关系 |
> |--------|---------|------|---------|
> | [[admire]] | ad- + mir(看) | 钦佩，赞赏 | 词义补充（admirable 的动词形式） |
> | [[admiration]] | admire + -ation | 钦佩，赞赏 | 词义补充 |
> | [[admirer]] | admire + -er(人) | 赞赏者，爱慕者 | 词义补充 |
> | [[miracle]] | mir(惊叹) + -acle | 奇迹 | 词义补充（同源词） |
