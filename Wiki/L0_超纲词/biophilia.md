...
> [!info] 基础信息
> **音标** /ˌbaɪəʊˈfɪliə/ | **词级** 超纲词 | **语义场** [[理性世界]]
...
bio-(生命) + phil(爱) + -ia(名词后缀，表状态)
**叙事**：bio（生命）+ phil（爱）+ ia（状态）→ 热爱生命的状态 → 亲生命性。建议创建词根笔记 [[bio-]]。
...
>
> 1. **对生命的热爱**（心理层面）
>    - → **热爱生命的天性**：人类天生亲近自然和生物的本能
>      - 激活条件：biophilia hypothesis, human biophilia
>    - → **对自然的亲近感**：在自然环境中感到舒适和愉悦
>      - 激活条件：biophilia in architecture, biophilic design

### 统筹（选择适用的模式）

- **一字一词概括**：biophilia 就是"爱生命"——对生命和自然的本能热爱
- **延伸中心**：从"热爱生命"延伸到"亲近自然"和"亲生命设计"

> [!check]- 链路验证
> - [x] **可逆性**：从"亲生命性"能反向推导到"对生命的热爱"
> - [x] **可统筹**：一句话——"biophilia 就是人类天生热爱生命和自然"
> - [x] **有支撑**：biophilia hypothesis（E.O. Wilson 提出）有学术支撑
...
> | 词性 | 释义 | 转换路径 |
> |------|------|---------|
> | n. | 热爱生命的天性 | 核心词性，bio+phil+ia 的组合 |
...
> |------|------------|---------|---------|---------|
> | [[nature-loving]] | 热爱自然的 | 口语化表达 | 人、生活方式 | 正面 |
> | [[environmentalism]] | 环保主义 | 强调保护环境的行动 | 政策、运动 | 正面 |
> | **biophilia** | 亲生命性 | 强调人类天生亲近生命的本能 | 人类心理、设计 | 正面/学术 |
>
> **"增"标记**：biophilia **(增-天生本能属性)** vs nature-loving（基准词：后天偏好）；biophilia **(增-学术理论框架)** vs environmentalism（基准词：行动导向）
...
> | 派生词 | 构词分析 | 释义 | 链接关系 |
> |--------|---------|------|---------|
> | [[biophilic]] | biophilia + -ic | 亲生命的 | 词义补充 |
> | [[biophobia]] | bio- + phobia(恐惧) | 恐生命性 | 词义补充（反义概念） |
