...
"""
第41批范围检查：
- 词条修改集合必须是 `.trae/batches/batch41_files.txt` 的子集
- 允许本批脚本、清单、报告一并改动
...
BATCH = REPO / ".trae" / "batches" / "batch41_files.txt"
ALLOWED_AUX = {
    ".trae/batches/batch41_files.txt",
    ".trae/reports/第41批次超纲词1001-1050_6.5-6.6_处理报告.md",
    ".trae/scripts/batch41_make_list.py",
    ".trae/scripts/batch41_apply.py",
    ".trae/scripts/batch41_online_fill.py",
    ".trae/scripts/batch41_browser_apply.py",
    ".trae/scripts/batch41_validate.py",
    ".trae/scripts/batch41_range_check.py",
    ".trae/scripts/batch41_rebuild_report.py",
    ".trae/scripts/tests/test_batch41_rules.py",
}
CHECKPOINT_FILES = [
    ".trae/scripts/batch41_make_list.py",
    ".trae/scripts/batch41_apply.py",
