...
"""
第40批范围检查：
- 词条修改集合必须是 `.trae/batches/batch40_files.txt` 的子集
- 允许本批脚本、清单、报告一并改动
...
BATCH = REPO / ".trae" / "batches" / "batch40_files.txt"
ALLOWED_AUX = {
    ".trae/batches/batch40_files.txt",
    ".trae/reports/第40批次超纲词901-1000_6.5-6.6_处理报告.md",
    ".trae/scripts/batch40_make_list.py",
    ".trae/scripts/batch40_apply.py",
    ".trae/scripts/batch40_online_fill.py",
    ".trae/scripts/batch40_browser_apply.py",
    ".trae/scripts/batch40_validate.py",
    ".trae/scripts/batch40_range_check.py",
    ".trae/scripts/batch40_rebuild_report.py",
    ".trae/scripts/tests/test_batch40_rules.py",
}
CHECKPOINT_FILES = [
    ".trae/scripts/batch40_make_list.py",
    ".trae/scripts/batch40_apply.py",
