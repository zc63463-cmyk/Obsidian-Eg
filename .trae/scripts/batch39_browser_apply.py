...
# -*- coding: utf-8 -*-
"""
将 browser fallback 命中的结构化结果合并回第39批词条。

输入：
- /data/user/work/batch39_browser_hits.json

输出：
- /data/user/work/batch39_browser_apply_stats.json
...
HITS_FILE = Path("/data/user/work/batch39_browser_hits.json")
STATS_FILE = Path("/data/user/work/batch39_browser_apply_stats.json")
