...
"""
重建第39批最终报告：
- 扫描 `.trae/batches/batch39_files.txt` 清单内每个词条的 `> [!example]- 语料`
...
from batch39_validate import VALID_TAG_RE
...
APPLY_STATS_PATH = Path("/data/user/work/batch39_apply_stats.json")
STATIC_CANDIDATES_PATH = Path("/data/user/work/batch39_static_candidates.json")
BROWSER_HITS_PATH = Path("/data/user/work/batch39_browser_hits.json")
