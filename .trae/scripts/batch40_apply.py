...
# -*- coding: utf-8 -*-
"""
第40批（L0_超纲词 第10批：901–1000）离线 apply：
- 仅修改：
...
输出：
- /data/user/work/batch40_needs_online.tsv
- /data/user/work/batch40_apply_stats.json
"""
...
NEEDS_ONLINE = Path("/data/user/work/batch40_needs_online.tsv")
STATS_JSON = Path("/data/user/work/batch40_apply_stats.json")
